...
export class EstadisticasComponent implements OnInit {
  ...
  public pieChartOptions: any = {
   ...
   public polarAreaChartOptions: any = {
    ...
    title: {
        display: true,
        text: 'Cantidad de Reservas y eventos',
        fontSize: 16
    }
  };
...
//polar
  public polarAreaChartLabels:string[] = ['Pizza muzzarella', 'Pizza napolitana', 'Porción de fugazzeta rellena', 'Empanada de Pollo', 'Empanada carne','Empanada de Limon','Faina','Agua mineral','coca cola','helado'];
  public polarAreaChartData:number[] = [80, 90, 30, 8, 15, 12, 10, 20, 20, 11];
  public polarAreaLegend:boolean = true;

  public polarAreaChartType:string = 'polarArea';
  
 // Radar
  public radarChartLabels:string[] = ['San Isidro', 'San Martin', 'CABA', 'Avellaneda'];
 
  public radarChartData:any = [
  
    {data: [2, 0, 1, 0], label: 'Reservas'},
    {data: [2, 4, 3, 1], label: 'Eventos'},
  ];
