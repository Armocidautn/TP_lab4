...
export class LoginComponent implements OnInit {
 ...
 public BotonLogin: boolean;
 public Botonocultartodo: boolean;
 public BotonSabores: boolean;
  ...
  constructor( private router: Router, private ws: WsService) {
   ...
   this.Botonocultartodo=true;
   this.BotonSabores=false;
...
{
 this.BotonLogin=false;
this.Botonocultartodo=false; 
this.BotonSabores=true;
}
